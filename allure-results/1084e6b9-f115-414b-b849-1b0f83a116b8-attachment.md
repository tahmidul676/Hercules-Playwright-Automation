  ...
  - generic:
    - generic:
          ...
          - generic [ref=e196]:
            ...
            - generic [ref=e205]:
              - table [ref=e207]:
                ...
                - rowgroup [ref=e222]:
                  - row "ORD-260510-236502-00014 1778404228853 2026-05-10 - 2,230 0.00 City Store 3 MPO 06 - Pending View Incoming Order Details Update Order" [ref=e223]:
                    - cell [ref=e224]:
                      - checkbox [ref=e225]
                    ...
                    - cell "View Incoming Order Details Update Order" [ref=e237]:
                      ...
                      - button "Update Order" [ref=e242] [cursor=pointer]:
                        - generic [ref=e243]: 
                  - row "ORD-260510-236502-00012 1778403481105 2026-05-10 - 6,210 0.00 City Store 3 MPO 06 - Pending View Incoming Order Details Update Order" [ref=e244]:
                    - cell [ref=e245]:
                      - checkbox [ref=e246]
                    - cell "ORD-260510-236502-00012" [ref=e247]
                    - cell "1778403481105" [ref=e248]
              ...
              - generic [ref=e265]:
                - combobox [ref=e268] [cursor=pointer]:
                  ...
                  - option "50 / page"
                  - option "100 / page"
                - navigation "Page navigation example" [ref=e269]:
                  - list [ref=e270]:
                    - listitem [ref=e271]:
                      - button "<<"
                    - listitem "You are on the first page" [ref=e272]:
                      - button "<" [disabled]
                    - listitem [ref=e273]:
                      - button "1" [disabled] [ref=e274]
                    - listitem "You are on the last page" [ref=e275]:
                      - button ">" [disabled]
                    - listitem [ref=e276]:
                      - button ">>" [disabled]
      - generic [ref=e278] [cursor=pointer]:
        - alert [ref=e279]:
          - img [ref=e281]
          - generic [ref=e283]: successfully logged in
        - button "close" [ref=e284]:
          - img [ref=e285]
        - progressbar "notification timer" [ref=e289]
```
