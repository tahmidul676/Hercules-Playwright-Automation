...
Call log:
  - waiting for locator('[role="option"]') to be visible
    5 × locator resolved to 5 elements. Proceeding with the first one: <div tabindex="-1" role="option" aria-disabled="false" aria-selected="false" id="react-select-4-option-0" class="react_select_custom__option react_select_custom__option--is-focused css-d7l1ni-option">Karwan Bazar Branch One</div>
