...
Call log:
  - waiting for getByRole('option', { name: 'Rampura Branch' })
    - locator resolved to <div tabindex="-1" role="option" aria-disabled="false" aria-selected="false" id="react-select-5-option-3" class="react_select_custom__option css-10wo9uf-option">Rampura Branch</div>
