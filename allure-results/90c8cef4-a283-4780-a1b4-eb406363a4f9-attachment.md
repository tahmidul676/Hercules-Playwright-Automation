...
> 45 |   expect(tableData.products).toHaveLength(3);
     |                              ^ Error: expect(received).toHaveLength(expected)
  46 |   expect(tableData.summary.netPayable).toBe(10420);
  47 |   expect(tableData.summary.netPayableInWords).toContain("Ten Thousand Four Hundred Twenty");
  48 | 
  49 |   // Optional: Validate individual items
  50 |   const firstItem = tableData.products[0];
  51 |   expect(firstItem.code).toBe("SKC01");
  52 |   expect(firstItem.quantity).toBe(10);
  53 | 
  54 | });
  55 | 
```