...
> 123 |     const cellText = await row.textContent();
  ...
  136 |       await this.page.evaluate((index) => {
  137 |         const rows = document.querySelectorAll("table tbody tr");
  138 |         const checkbox = rows[index].querySelector("input[type='checkbox']");
  139 |         if (checkbox) checkbox.click();
  140 |       }, i);
  141 | 
  142 |       found = true;
  143 |       break;
