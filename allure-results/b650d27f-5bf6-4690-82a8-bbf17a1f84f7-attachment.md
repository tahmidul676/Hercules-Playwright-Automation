...
Call log:
  - waiting for getByRole('option', { name: 'Rampura Route 1' })
    - locator resolved to <div tabindex="-1" role="option" aria-disabled="false" aria-selected="false" id="react-select-5-option-0" class="react_select_custom__option react_select_custom__option--is-focused css-d7l1ni-option">Rampura Route 1</div>
